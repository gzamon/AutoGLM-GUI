...
class ActionTimingConfig:
    ...
    # Text input related delays (in seconds) - optimized for speed
...
class DeviceTimingConfig:
    ...
    # Default delays for various device operations (in seconds) - optimized for speed
    ...
    default_long_press_delay: float = 0.5  # Default delay after long press
    ...
    default_launch_delay: float = 0.5  # Default delay after launching app
